...
public class LottoTrendBlueActivity extends UIActivity<ActivityLottoTrendBinding> implements DDTrendChart.ISelectedChangeListener {
    ...
    private Handler mHandler = new Handler() {
        public void handleMessage(Message paramMessage) {
            ...
            dismissProgress();
            LottoTrendBlueActivity.this.mTrendChart.updateData("50", (ArrayList) paramMessage.obj);
        }
    };
